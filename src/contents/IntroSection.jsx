...
import BGImage from '../assets/images/projectpics/homepage.jpg';
    ...
    return (
        <section className="relative top-0 h-[95vh]">
            ...
            <div className='absolute top-0 z-10 w-full h-full flex flex-col justify-center items-center text-white'>
                ...
                <h4 className='mt-3 text-2xl sm:text-4xl text-red-700 font-medium'>{runningText}<span className='text-DodgerBlue-700'>|</span></h4>
                ...
                <a href="Niranjan_Panigrahi-resume.pdf" target="_blank" rel="noreferrer">
